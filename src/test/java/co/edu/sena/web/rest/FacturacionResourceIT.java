...
class FacturacionResourceIT {
    ...
    private static final String DEFAULT_NOMBRECLIENTE = "AAAAAAAAAA";
    private static final String UPDATED_NOMBRECLIENTE = "BBBBBBBBBB";
    ...
    public static Facturacion createEntity(EntityManager em) {
        Facturacion facturacion = new Facturacion()
            ...
            .nombrecliente(DEFAULT_NOMBRECLIENTE)
    ...
    public static Facturacion createUpdatedEntity(EntityManager em) {
        Facturacion facturacion = new Facturacion()
            ...
            .nombrecliente(UPDATED_NOMBRECLIENTE)
    ...
    void createFacturacion() throws Exception {
        ...
        assertThat(testFacturacion.getNombrecliente()).isEqualTo(DEFAULT_NOMBRECLIENTE);
    ...
    void checkNombreclienteIsRequired() throws Exception {
        int databaseSizeBeforeTest = facturacionRepository.findAll().size();
        // set the field null
        facturacion.setNombrecliente(null);
    ...
    void getAllFacturacions() throws Exception {
        ...
        restFacturacionMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombrecliente").value(hasItem(DEFAULT_NOMBRECLIENTE)))
    ...
    void getFacturacion() throws Exception {
        ...
        restFacturacionMockMvc
            ...
            .andExpect(jsonPath("$.nombrecliente").value(DEFAULT_NOMBRECLIENTE))
    ...
    void putNewFacturacion() throws Exception {
        ...
        updatedFacturacion.fechaFactura(UPDATED_FECHA_FACTURA).nombrecliente(UPDATED_NOMBRECLIENTE).valorFactura(UPDATED_VALOR_FACTURA);
        ...
        assertThat(testFacturacion.getNombrecliente()).isEqualTo(UPDATED_NOMBRECLIENTE);
